                        ...
                        <TiltCard className="h-full">
                            <Card className="h-full flex flex-col items-start p-6 hover:border-deep-navy/30 transition-all duration-300">
                                <div className="mb-4">
                                    ...
                                    <p className="text-sm text-gray-700 font-bold mb-1">( 앱 최적화 )</p>
                                    <p className="text-xs text-gray-600 font-semibold mb-3">핵심만 쏙 골라 담았습니다</p>
                                    <p className="text-base text-vivid-orange font-bold">우리가게 이쁘게 만들기</p>
                                </div>
                                <div className="mb-6 flex items-end gap-1">
                                    <span className="text-3xl font-bold text-deep-navy">119,000</span>
                                    <span className="text-base text-gray-500 mb-1">원</span>
                                </div>
                        ...
                        <TiltCard className="h-full">
                            <Card className="relative h-full flex flex-col items-start p-6 border-vivid-orange/50 ring-2 ring-vivid-orange/20 shadow-2xl bg-white scale-105">
                                ...
                                <div className="mb-4 text-left">
                                    ...
                                    <p className="text-xs text-gray-600 font-semibold mb-3">전문 컨설팅 포함 패키지</p>
                                    <p className="text-base text-vivid-orange font-bold text-lg">우리가게 이쁘게 꾸미고,<br />문제점 분석 및 개선</p>
                                </div>
                                <div className="mb-6 flex items-end gap-1">
                        ...
                        <TiltCard className="h-full">
                            <Card className="h-full flex flex-col items-start p-6 hover:border-deep-navy/30 transition-all duration-300">
                                <div className="mb-4">
                                    ...
                                    <p className="text-sm text-gray-700 font-bold mb-1">(정밀 컨설팅)</p>
                                    <p className="text-xs text-gray-600 font-semibold mb-3">부담 없는 1회성 진단</p>
                                    <div className="space-y-1">
                                        <p className="text-base text-vivid-orange font-bold">문제점/경쟁업체 분석</p>
                                        <p className="text-base text-vivid-orange font-bold">및 맞춤 컨설팅</p>
                                    </div>
                                </div>
                                <div className="mb-6 flex items-end gap-1">
